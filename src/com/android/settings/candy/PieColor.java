 ...
 * Portions (C) 2016 CandySiX Project
 *
...
public class PieColor extends SettingsPreferenceFragment implements OnPreferenceChangeListener {
    ...
    private static final String CANDY_PIE_ENABLE_COLOR = "candy_pie_enable_color";
    private static final String CANDY_PIE_BACKGROUND = "candy_pie_background";
    private static final String CANDY_PIE_SELECT = "candy_pie_select";
    private static final String CANDY_PIE_OUTLINES = "candy_pie_outlines";
    private static final String CANDY_PIE_STATUS_CLOCK = "candy_pie_status_clock";
    private static final String CANDY_PIE_STATUS = "candy_pie_status";
    private static final String CANDY_PIE_CHEVRON = "candy_pie_chevron";
    private static final String CANDY_PIE_BUTTON_COLOR = "candy_pie_button_color";
    private static final String CANDY_PIE_JUICE = "candy_pie_juice";
    ...
    public void refreshSettings() {
        ...
        addPreferencesFromResource(R.xml.candy_pie_color);
        ...
        mEnableColor = (SwitchPreference) findPreference(CANDY_PIE_ENABLE_COLOR);
        mEnableColor.setChecked(enableColor);
        mEnableColor.setOnPreferenceChangeListener(this);

        mPieBg =
                (ColorPickerPreference) findPreference(CANDY_PIE_BACKGROUND);
        intColor = Settings.System.getInt(mResolver,
                Settings.System.CANDY_PIE_BACKGROUND,
                0x04000000);
        ...
        mSelect =
                (ColorPickerPreference) findPreference(CANDY_PIE_SELECT);
        intColor = Settings.System.getInt(mResolver,
                Settings.System.CANDY_PIE_SELECT,
                DEFAULT_COLOR);
        ...
        mOutlines =
                (ColorPickerPreference) findPreference(CANDY_PIE_OUTLINES);
        intColor = Settings.System.getInt(mResolver,
                Settings.System.CANDY_PIE_OUTLINES,
                DEFAULT_COLOR);
        ...
        mStatusClock =
                (ColorPickerPreference) findPreference(CANDY_PIE_STATUS_CLOCK);
        intColor = Settings.System.getInt(mResolver,
                Settings.System.CANDY_PIE_STATUS_CLOCK,
                DEFAULT_COLOR);
        ...
        mStatus =
                (ColorPickerPreference) findPreference(CANDY_PIE_STATUS);
        intColor = Settings.System.getInt(mResolver,
                Settings.System.CANDY_PIE_STATUS,
                DEFAULT_COLOR);
        ...
        mChevron =
                (ColorPickerPreference) findPreference(CANDY_PIE_CHEVRON);
        intColor = Settings.System.getInt(mResolver,
                Settings.System.CANDY_PIE_CHEVRON,
                DEFAULT_COLOR);
        ...
        mBtnColor =
                (ColorPickerPreference) findPreference(CANDY_PIE_BUTTON_COLOR);
        intColor = Settings.System.getInt(mResolver,
                Settings.System.CANDY_PIE_BUTTON_COLOR,
                DEFAULT_COLOR);
        ...
        mJuice =
                (ColorPickerPreference) findPreference(CANDY_PIE_JUICE);
        intColor = Settings.System.getInt(mResolver,
                Settings.System.CANDY_PIE_JUICE,
                DEFAULT_COLOR);
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        ...
        if (preference == mEnableColor) {
            ...
            Settings.System.putInt(mResolver,
                Settings.System.CANDY_PIE_ENABLE_COLOR,
                value ? 1 : 0);
            return true;
            ...
            Settings.System.putInt(getActivity().getContentResolver(),
                    Settings.System.CANDY_PIE_BACKGROUND, intHex);
            return true;
            ...
            int intHex = ColorPickerPreference.convertToColorInt(hex);
            Settings.System.putInt(getActivity().getContentResolver(),
                    Settings.System.CANDY_PIE_SELECT, intHex);
            return true;
            ...
            int intHex = ColorPickerPreference.convertToColorInt(hex);
            Settings.System.putInt(getActivity().getContentResolver(),
                    Settings.System.CANDY_PIE_OUTLINES, intHex);
            return true;
            ...
            int intHex = ColorPickerPreference.convertToColorInt(hex);
            Settings.System.putInt(getActivity().getContentResolver(),
                    Settings.System.CANDY_PIE_STATUS_CLOCK, intHex);
            return true;
            ...
            int intHex = ColorPickerPreference.convertToColorInt(hex);
            Settings.System.putInt(getActivity().getContentResolver(),
                    Settings.System.CANDY_PIE_STATUS, intHex);
            return true;
            ...
            int intHex = ColorPickerPreference.convertToColorInt(hex);
            Settings.System.putInt(getActivity().getContentResolver(),
                    Settings.System.CANDY_PIE_CHEVRON, intHex);
            return true;
            ...
            int intHex = ColorPickerPreference.convertToColorInt(hex);
            Settings.System.putInt(getActivity().getContentResolver(),
                    Settings.System.CANDY_PIE_BUTTON_COLOR, intHex);
            return true;
            ...
            int intHex = ColorPickerPreference.convertToColorInt(hex);
            Settings.System.putInt(getActivity().getContentResolver(),
                    Settings.System.CANDY_PIE_JUICE, intHex);
            return true;
        }
        return false;
    }
        ...
        public Dialog onCreateDialog(Bundle savedInstanceState) {
            ...
            switch (id) {
                case DLG_RESET:
                    ...
                    .setNeutralButton(R.string.reset_android,
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            Settings.System.putInt(getOwner().mResolver,
                                    Settings.System.CANDY_PIE_ENABLE_COLOR, 1);
                            Settings.System.putInt(getOwner().mResolver,
                                    Settings.System.CANDY_PIE_BACKGROUND,
                                    0x04000000);
                            Settings.System.putInt(getOwner().mResolver,
                    ...
                    .setPositiveButton(R.string.reset_candy,
                        new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int which) {
                            Settings.System.putInt(getOwner().mResolver,
                                    Settings.System.CANDY_PIE_ENABLE_COLOR, 1);
