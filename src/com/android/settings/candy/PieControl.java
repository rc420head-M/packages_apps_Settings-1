...
public class PieControl extends SettingsPreferenceFragment implements OnPreferenceChangeListener {
    ...
    private static final String CANDY_PIE_SIZE = "candy_pie_size";
    private static final String CANDY_PIE_GRAVITY = "candy_pie_gravity";
    private static final String CANDY_PIE_MODE = "candy_pie_mode";
    private static final String CANDY_PIE_ANGLE = "candy_pie_angle";
    private static final String CANDY_PIE_GAP = "candy_pie_gap";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        addPreferencesFromResource(R.xml.candy_pie_control);
        ...
        mPieSize = (ListPreference) prefSet.findPreference(CANDY_PIE_SIZE);
        ...
        mPieGravity = (ListPreference) prefSet.findPreference(CANDY_PIE_GRAVITY);
        int pieGravity = Settings.System.getInt(mResolver,
                Settings.System.CANDY_PIE_GRAVITY, 2);
        mPieGravity.setValue(String.valueOf(pieGravity));
        mPieGravity.setOnPreferenceChangeListener(this);

        mPieMode = (ListPreference) prefSet.findPreference(CANDY_PIE_MODE);
        ...
        mPieGap = (ListPreference) prefSet.findPreference(CANDY_PIE_GAP);
        ...
        mPieAngle = (ListPreference) prefSet.findPreference(CANDY_PIE_ANGLE);
